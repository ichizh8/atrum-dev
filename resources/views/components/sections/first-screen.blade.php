    ...
    <x-container>
        <div class="grid grid-cols-9 gap-4 mb-15 max-sm:mb-5">
            <div class="col-span-9 sm:relative">
                ...
                <h1 class="relative an_text-appear">Smart systems used to<br />cost a fortune.<br /><span class="gradient-text">They don't anymore.</span></h1>
            </div>
        </div>
        <div class="grid grid-cols-9 gap-4 items-center">
            ...
            <div class="col-span-4 max-sm:col-span-9 relative z-10">
                <div class="mb-20 max-sm:mb-15 an_text-split">
                    <h2 class="mb-6 max-sm:mb-10 split h4" data-delay="1">ML pipelines, UX research, and security audits used to be enterprise-only. We bring all of it to the companies that need it most.</h2>
                    <p class="split" data-delay="1.3">We use AI orchestration to do work that used to require a 30-person agency. The difference is we actually review what AI produces. Architectures get stress-tested. Decisions come from behavior data we collected ourselves. And when something ships, it tends to stay up.</p>
                </div>
                <div class="flex items-center gap-x-4 gap-y-5 flex-wrap max-sm:justify-center">
                    ...
                    <div class="an_zoom-appear" data-delay="1.9">
                        <x-btn href="#our-process" variant="secondary">See How It Works</x-btn>
                    </div>
                </div>
            </div>
        </div>
